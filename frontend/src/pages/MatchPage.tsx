...
import { talentApi, type LearningPath, type MatchResult, type MatchRun, type ProfileSummary } from '../api/talent'
...
const gapLabels: Record<string, string> = { evidence_insufficient: '证据不足', transferable: '可迁移', depth_insufficient: '掌握深度不足', confirmed_missing: '已确认缺失' }
