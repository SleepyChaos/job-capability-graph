...
function edgeStyle(edge: RelationEdge, capabilityDomains: Map<string, string>, zoomLevel: SemanticZoomLevel) {
  ...
  return {
    ...
    lineDash: hierarchyEdge || edge.importance < 60 ? [4, 3] as number[] : undefined,
  }
}
