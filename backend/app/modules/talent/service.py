...
MATCH_ALGORITHM_VERSION = "r_daea_pjf_v9_business_evidence_ten_dimension"
PATH_ALGORITHM_VERSION = "gap_path_topo_v2_dimension_fallback"
...
MIN_POSTING_RERANK_COUNT = 200
POSTING_RERANK_LIMIT_MULTIPLIER = 40

# Deterministic title families protect retrieval from cross-occupation false positives.
# They influence candidate ordering only; the ten scoring dimensions and weights remain unchanged.
ROLE_FAMILY_KEYWORDS = {
    "finance": ("财务", "会计", "成本", "预算", "审计", "资金", "finance", "accounting"),
    "securities": ("证券事务", "投资者关系", "董秘", "ir"),
    "procurement": ("采购", "寻源", "sourcing"),
    "supply_chain": ("供应链", "计划物控", "生产物料控制", "pmc", "物流"),
    "human_resources": (
        "人力资源",
        "招聘",
        "人才发展",
    ...
    "sales": ("销售", "大客户", "客户经理", "商务拓展", "业务拓展", "渠道", "bd"),
    "product": ("产品经理", "产品负责人", "产品策略", "product manager"),
    "project": ("项目经理", "项目工程师", "项目管理", "project manager"),
    "quality": ("质量", "品质", "供应商质量", "研发质量", "pqe", "sqe", "qe", "qa"),
    "mechanical": ("机械", "结构", "机加工", "cnc", "数控", "防爆结构"),
    "industrial_design": ("工业设计", "外观设计", "造型设计"),
    "manufacturing_process": ("工艺", "制程", "制造工程", "npi", "丝印", "抛光", "表面处理"),
    "electrical": ("电气", "电控", "自动化", "plc"),
    "hardware_chip": (
        "硬件",
        "电子",
        "芯片",
    ...
    "software": ("软件", "嵌入式", "固件", "c++", "c#", "工具链", "开发工程师"),
    "data_simulation": ("数据分析", "数采", "数据采集", "仿真", "建模", "cae"),
    "algorithm": ("算法", "机器学习", "深度学习", "计算机视觉", "slam"),
    "security": ("信息安全", "网络安全", "数据安全", "产品安全", "安全测试"),
    "optics": ("光学", "激光雷达", "镜头", "成像", "光电"),
    "materials": ("材料", "金属材料", "高分子", "复合材料", "铜箔"),
    "media": ("短视频", "编导", "拍摄", "剪辑", "视频制作", "内容制作"),
    "warehouse": ("立库", "仓储", "wms", "wcs", "物流规划"),
    "internship": ("实习生", "实习岗位", "校招", "应届生"),
...
ROLE_GENERIC_PARTS = {"技术", "运营", "市场", "均可", "通用", "相关", "其他"}

# Raw-resume/JD concepts complement the governed technology taxonomy.  They do
# not create skills or call an LLM; they only measure source-text evidence in
# the existing task-semantic and project-evidence dimensions.  This prevents a
# richly specified JD from scoring below a vague JD merely because the latter
# produced no structured requirements.
JD_EVIDENCE_CONCEPTS = {
    "explosion_design": (3.0, ("防爆", "隔爆", "增安", "本安", "ex d", "ex e", "ex ib")),
    "explosion_standard": (
        3.0,
        ("gb/t 3836", "gb 3836", "iec 60079", "atex", "iecex", "防爆标准"),
    ),
    "explosion_certification": (
        2.5,
        ("防爆认证", "防爆合格证", "防爆ccc", "认证机构", "认证取证"),
    ),
    "finite_element_analysis": (2.0, ("ansys", "有限元", "fea", "结构应力分析")),
    "structural_verification": (
        1.5,
        ("强度校核", "负载校核", "耐爆压力校核", "力学分析", "寿命分析", "失效风险"),
    ),
    "mechanical_structure": (1.0, ("机械结构", "结构设计", "机械设计")),
    "materials_process": (
        1.5,
        ("材料选型", "加工工艺", "表面处理", "压铸", "钣金", "机加工", "开模"),
    ),
    "cad_drawing": (
        1.0,
        ("solidworks", "solid works", "creo", "autocad", "3d建模", "工程图纸", "2d图纸"),
    ),
    "bom": (0.8, ("bom", "物料清单")),
    "mass_production": (1.0, ("量产", "试产", "样机", "制样", "可量产性")),
    "robotics": (2.0, ("机器人", "双足", "四足", "协作机器人", "扫地机", "割草机")),
    "transmission": (1.5, ("关节模组", "轴承", "丝杆", "齿轮", "连杆", "传动设计")),
    "sales_management": (
        2.0,
        ("销售管理", "销售团队", "带领团队", "团队管理", "下辖", "销售总监"),
    ),
    "regional_sales": (2.0, ("区域销售", "大区销售", "区域市场", "区域业务")),
    "sales_strategy": (
        1.5,
        ("销售策略", "销售计划", "市场渗透", "销售目标", "销售指标", "业绩目标"),
    ),
    "customer_development": (
        1.5,
        ("客户开发", "开发新客户", "开拓新客户", "客户资源", "客户拜访"),
    ),
    "channel_distributor": (
        2.0,
        ("渠道", "经销商", "集成商", "校企合作", "终端客户"),
    ),
    "key_account": (
        1.5,
        ("大客户", "重点客户", "ka客户", "企业客户", "战略直供", "客户运营"),
    ),
    "solution_sales": (
        2.0,
        ("方案式销售", "解决方案", "项目型销售", "定制化服务", "产品+解决方案"),
    ),
    "commercial_negotiation": (
        1.5,
        ("商务谈判", "合同谈判", "合同签订", "商务洽谈", "方案报价"),
    ),
    "order_collection": (1.0, ("订单", "回款", "售后", "销售全流程")),
    "market_intelligence": (
        1.0,
        ("市场分析", "竞品", "行业动态", "市场情报", "客户反馈"),
    ),
    "customer_relationship": (
        1.0,
        ("客户关系", "客户满意度", "客情", "复购", "客户维护"),
    ),
    "cross_functional": (
        1.0,
        ("跨部门", "协同技术", "协同产品", "协同售后", "部门协同"),
    ),
    "industrial_automation_sales": (
        2.0,
        ("工业自动化", "智能制造", "自动化设备", "数据采集设备", "工业仪器"),
    ),
    "education_sales": (
        2.0,
        ("职业院校", "科研院所", "教育行业", "产教融合", "教学设备"),
    ),
    "retail_supply_chain": (
        2.0,
        ("快消品", "新零售", "商超", "鞋服", "跨境电商", "物流流通", "供应链"),
    ),
    "mobile_robot": (2.0, ("amr", "agv", "移动机器人", "仓储机器人")),
}

SCENARIO_CONCEPT_KEYS = {
    "explosion_design",
    "explosion_standard",
    "robotics",
    "industrial_automation_sales",
...
BUSINESS_TRANSFER_CONCEPT_KEYS = {
    "sales_management",
    "regional_sales",
    "sales_strategy",
    "customer_development",
...
class PostingMatchTarget:
    """Duck-typed cluster target for an active posting without cluster membership."""

    job_cluster_version_id: int | None
    stable_cluster_code: str
    cluster_label: str


# 十维机械评分保持不变；压缩的是端到端业务流程，不是评分信息量。
MATCH_DIMENSIONS = (
...
PROFILE_DIMENSION_LABELS = {
    ...
    "education_major": "学历专业",
    "work_experience": "工作经验",
    "application_scenarios": "应用场景",
    "generic_capabilities": "通用能力",
}
...
QUESTION_BANK = (
    ...
    (
        ...
        "简历中还没有清楚说明岗位或项目职责。请选一段经历，说明你负责什么、采取了哪些行动，以及结果。",
    ),
    (
        "required_skills",
        "简历中还没有识别出明确的专业技能。请列出你能实际使用的核心技能，并说明各自用在什么任务中。",
    ),
    (
        "tools_platforms",
        "简历中还没有识别出使用过的工具或平台。请列出实际使用过的软件、框架、仿真或开发平台，并说明用途。",
    ),
    ("education_major", "简历中还缺少学历或专业信息。请补充最高学历、学校、专业及毕业时间。"),
    (
        "work_experience",
        "简历中还没有清楚的工作经历。请补充一段公司或组织、岗位、起止时间和主要工作内容。",
    ),
    (
        "application_scenarios",
        "简历中还没有明确体现应用场景。你的经历主要面向哪些行业、产品或机器人场景？",
    ),
    (
        "generic_capabilities",
        "简历中还没有明确体现通用能力。请结合实例说明沟通协作、问题分析、项目推进、质量或交付能力。",
    ),
)
...
QUESTION_VALUE_FACTORS = {
    ...
    "job_responsibilities": {"impact": 0.88, "answerability": 0.90, "privacy_risk": 0.05},
    "required_skills": {"impact": 0.95, "answerability": 0.90, "privacy_risk": 0.05},
    "tools_platforms": {"impact": 0.82, "answerability": 0.95, "privacy_risk": 0.05},
    "education_major": {"impact": 0.72, "answerability": 0.98, "privacy_risk": 0.05},
    "work_experience": {"impact": 0.86, "answerability": 0.90, "privacy_risk": 0.05},
    "application_scenarios": {"impact": 0.68, "answerability": 0.90, "privacy_risk": 0.05},
    "generic_capabilities": {"impact": 0.58, "answerability": 0.85, "privacy_risk": 0.05},
}
...
def publish_profile(db: Session, *, version_code: str) -> dict:
    ...
    if not _profile_can_publish(version):
...
def get_match_evidence_question(db: Session, *, result_code: str) -> dict:
    ...
    return {
        ...
        "minimal_improvement_sets": recommendation.get("minimal_improvement_sets", []),
...
def answer_match_evidence_question(
    ...
    *,
    ...
    missing_ids = {int(item) for item in acquisition.get("confirmed_missing_technology_ids", [])}
    ...
    version = CandidateProfileVersion(
        ...
        preference_json=json.loads(json.dumps(previous.preference_json or {}, ensure_ascii=False)),
        fact_json=fact_json,
        insight_json={
    ...
    if evidence_state != "confirmed_missing":
        db.add(
            CandidateSkillEvidence(
                ...
                confidence_score=Decimal("88" if evidence_state == "contextual" else "60"),
                user_confirmed=True,
            )
        )
    db.add(
    ...
    return {
        ...
        "evidence_update": {
            ...
            "technology_name": question.get("technology_name"),
            "evidence_state": evidence_state,
            "mechanical_confidence": 88.0
            if evidence_state == "contextual"
            else (0.0 if evidence_state == "confirmed_missing" else 60.0),
        },
...
def run_matching(db: Session, *, version_code: str, limit: int = 5) -> dict:
    ...
    context = _context(db)
    resume_document = db.get(ResumeDocument, version.resume_document_id)
    source_resume_text = resume_document.content_text if resume_document is not None else ""
    resume_text = _profile_evidence_text(version, source_resume_text)
    ...
    active_postings = list(
        db.scalars(
            select(JobPosting)
            .where(JobPosting.posting_status_code == "active")
            .order_by(JobPosting.job_posting_id)
        )
    )
    posting_snapshot_hash = hashlib.sha256(
        "|".join(
            f"{item.job_posting_id}:{item.updated_at.isoformat() if item.updated_at else ''}"
            for item in active_postings
        ).encode("utf-8")
    ).hexdigest()
    snapshot_payload = {
        "version_code": version.version_code,
        ...
        "confirmed_missing_technology_ids": sorted(_confirmed_missing_technology_ids(version)),
        "target_role": version.target_role_text,
        "preferences": version.preference_json or {},
        "resume_content_hash": (
            resume_document.content_hash if resume_document is not None else None
        ),
        ...
        "active_posting_count": len(active_postings),
        "active_posting_snapshot_hash": posting_snapshot_hash,
    ...
    cluster_by_job = {
        job_posting_id: cluster
        for job_posting_id, cluster in db.execute(
            select(JobClusterMember.job_posting_id, JobClusterVersion)
            .join(
                JobClusterVersion,
                JobClusterVersion.job_cluster_version_id == JobClusterMember.job_cluster_version_id,
            )
            .where(JobClusterVersion.clustering_run_id == context.run.clustering_run_id)
        )
    }
    profile_text = " ".join(
    ...
    for posting in active_postings:
        posting_skill_ids = {
            projected
            for signal in signals_by_job.get(posting.job_posting_id, [])
            if (projected := _ancestor_at_level(context.nodes, signal.technology_node_id, "L3"))
            is not None
        }
        skill_recall = (
            len(profile_skill_ids & posting_skill_ids) / len(profile_skill_ids)
            if profile_skill_ids
            else 0.0
        )
        skill_precision = (
            len(profile_skill_ids & posting_skill_ids) / len(posting_skill_ids)
            if posting_skill_ids
            else 0.0
        )
        semantic_score = (
            _text_overlap(
                ...
                " ".join(
                    part
                    for part in [
                        posting.job_title_normalized,
                        posting.job_title_raw,
                        posting.jd_clean_text[:2000],
                    ]
                    if part
                ),
            )
        ...
        document_coverage = _jd_evidence_coverage(resume_text, posting.jd_clean_text or "")
        if document_coverage is not None:
            semantic_score = 0.35 * semantic_score + 0.65 * document_coverage
        role_relevance = _role_title_relevance(
            version.target_role_text,
            posting.job_title_normalized or posting.job_title_raw,
        )
        role_band = _role_relevance_band(role_relevance)
        if version.target_role_text:
            retrieval_score = round(
                100.0
                * (
                    0.40 * skill_recall
                    + 0.10 * skill_precision
                    + 0.15 * semantic_score
                    + 0.35 * role_relevance
                ),
                6,
            ...
            retrieval_score = round(
                100.0 * (0.55 * skill_recall + 0.15 * skill_precision + 0.30 * semantic_score),
                6,
            )
        retrieved.append((role_band, role_relevance, retrieval_score, posting))
    retrieved.sort(key=lambda item: (-item[0], -item[2], -item[1], item[3].job_code))
    rerank_count = min(
        len(retrieved),
        max(MIN_POSTING_RERANK_COUNT, limit * POSTING_RERANK_LIMIT_MULTIPLIER),
    )
    scored = []
    for retrieval_rank, (role_band, role_relevance, retrieval_score, posting) in enumerate(
        retrieved[:rerank_count], 1
    ):
        cluster = cluster_by_job.get(posting.job_posting_id)
        ...
        scored_item.update(
            {
                ...
                "role_relevance_band": role_band,
            }
        )
        scored.append(scored_item)
    scored.sort(
        key=lambda item: (
            -item["role_relevance_band"],
            -item["overall_score"],
            -item["role_relevance"],
            -item["retrieval_score"],
            item["posting"].job_code,
        )
    )
    for rank, scored_item in enumerate(scored[:limit], 1):
        cluster = scored_item["cluster"]
        posting = scored_item["posting"]
        result = CandidateMatchResult(
            ...
            representative_job_posting_id=posting.job_posting_id,
            rank_no=rank,
            ...
            recommendation_json={
                ...
                "evidence_question_candidates": scored_item["evidence_question_candidates"],
                "minimal_improvement_sets": scored_item["minimal_improvement_sets"],
                "retrieval": {
                    "candidate_scope": "all_active_job_postings",
                    "candidate_count": len(active_postings),
                    "reranked_count": rerank_count,
                    "retrieval_rank": scored_item["retrieval_rank"],
                    "retrieval_score": scored_item["retrieval_score"],
                    "role_relevance": scored_item["role_relevance"],
                    "role_relevance_band": scored_item["role_relevance_band"],
                    "role_constraint_applied": bool(version.target_role_text),
                    "ranking_unit": "job_posting",
                },
            },
        )
        db.add(result)
...
def create_learning_path(db: Session, *, result_code: str) -> dict:
    ...
    existing = db.scalar(
        select(CandidateLearningPath).where(
            ...
            CandidateLearningPath.algorithm_version == PATH_ALGORITHM_VERSION,
        )
    )
    if existing:
    ...
    steps.extend(
        _dimension_development_steps(
            db,
            result,
            start_step_no=len(steps) + 1,
            limit=max(0, 6 - len(steps)),
            has_capability_gaps=bool(gaps),
        )
    )
    if not steps:
        raise TalentWorkflowError(
            "当前匹配结果没有可执行的能力差距；无需生成空路径，请返回匹配页查看已覆盖能力"
        )
    latest_version = db.scalar(
        select(func.max(CandidateLearningPath.version_no)).where(
            CandidateLearningPath.candidate_match_result_id == result.candidate_match_result_id
        )
    )
    path = CandidateLearningPath(
        ...
        summary_text=(
            f"由{len(gaps[:6])}项能力差距和"
            f"{len(steps) - len(gaps[:6])}项评分维度弱项生成{topo_note}，"
            "完成后重新提交项目证据并重算匹配。"
        ),
        steps_json=steps,
    )
        ...
        steps.append(
            {
                ...
                "gap_type_code": gap.gap_type_code,
                "depends_on": sorted(position[dep] + 1 for dep in depends[idx] if dep in position),
                "learning_focus": f"补齐{node.technology_name}的核心概念、工具链和工程边界",
                "practice_task": (
                    f"围绕{node.technology_name}完成一个与目标岗位场景一致的可验证实践"
                ),
...
DIMENSION_DEVELOPMENT_RULES = {
    "required_capability_fit": {
        "threshold": 85.0,
        "name": "必备能力证据补强",
        "focus": "逐条对照岗位必备要求，补齐尚未被简历事实直接证明的能力",
        "task": "选取一项未充分覆盖的必备要求，完成对应实践并记录关键决策与结果",
        "verification": "提交岗位要求对照表、实践产出、量化结果和复盘",
        "weeks": 2,
    },
    "bonus_capability_fit": {
        "threshold": 70.0,
        "name": "加分能力建设",
        "focus": "选择与目标岗位最相关的加分要求，形成可验证的新增能力",
        "task": "完成一项岗位加分要求对应的练习或小型项目",
        "verification": "提交产出物、应用说明和可复核结果",
        "weeks": 2,
    },
    "proficiency_fit": {
        "threshold": 80.0,
        "name": "能力深度证明",
        "focus": "把已有能力从使用经历提升为可复核的深度与熟练度证据",
        "task": "围绕目标岗位核心能力完成一次复杂任务，并记录难点、方案与取舍",
        "verification": "提交过程记录、关键指标、个人贡献和失败复盘",
        "weeks": 2,
    },
    "task_semantic_fit": {
        "threshold": 80.0,
        "name": "岗位任务对齐",
        "focus": "补充与目标岗位核心职责直接对应的任务经历",
        "task": "按目标岗位的一项核心职责完成模拟交付或梳理既有同类项目",
        "verification": "提交任务说明、交付物、个人职责和结果指标",
        "weeks": 2,
    },
    "project_evidence_fit": {
        "threshold": 90.0,
        "name": "项目证据与作品集",
        "focus": "将已有项目整理成目标岗位可以直接审阅的证据链",
        "task": "选择最相关项目制作案例页，写清背景、职责、过程、产出和量化结果",
        "verification": "提交作品集或案例文档，并附可核验产出与指标",
        "weeks": 1,
    },
    "recency_fit": {
        "threshold": 70.0,
        "name": "近期实践更新",
        "focus": "用近期实践证明相关能力仍可熟练应用",
        "task": "完成一个与目标岗位核心任务相关的近期实践并保留过程记录",
        "verification": "提交带日期的产出、指标和复盘记录",
        "weeks": 1,
    },
    "scenario_fit": {
        "threshold": 75.0,
        "name": "行业场景迁移验证",
        "focus": "理解目标行业场景约束，并证明已有经验能够迁移",
        "task": "针对目标行业场景完成需求分析、方案设计和风险清单",
        "verification": "提交场景分析、方案文档、约束清单和验证结论",
        "weeks": 2,
    },
    "level_fit": {
        "threshold": 75.0,
        "name": "岗位级别职责证明",
        "focus": "补充与目标岗位级别对应的独立负责、协作或带领范围证据",
        "task": "整理一个能证明职责范围与决策影响力的代表案例",
        "verification": "提交职责边界、协作范围、关键决策和业务结果",
        "weeks": 1,
    },
}


def _dimension_development_steps(
    db: Session,
    result: CandidateMatchResult,
    *,
    start_step_no: int,
    limit: int,
    has_capability_gaps: bool,
) -> list[dict]:
    """为词库未覆盖的弱项生成证据型步骤，不把偏好未知当作能力缺失。"""
    if limit <= 0:
        return []
    rows = list(
        db.scalars(
    ...
    dimensions = (
        ...
        or result.dimension_json
        or []
    )
    candidates = []
    for dimension in dimensions:
        code = dimension.get("code")
        rule = DIMENSION_DEVELOPMENT_RULES.get(code)
        status = dimension.get("status", "scored")
        if rule is None or status == "neutral_unknown":
            continue
        if has_capability_gaps and code in {
            "required_capability_fit",
            "bonus_capability_fit",
            "task_semantic_fit",
        }:
        ...
        if score >= threshold:
            continue
        priority = (threshold - score) * float(dimension.get("weight", 0.0))
        candidates.append((priority, code, score, rule))
    candidates.sort(reverse=True, key=lambda item: item[0])
    steps = []
    for offset, (_priority, code, score, rule) in enumerate(candidates[:limit]):
        steps.append(
            {
                "step_no": start_step_no + offset,
                "technology_node_id": None,
                "technology_name": rule["name"],
                "gap_id": None,
                "gap_type_code": "dimension_evidence",
                "depends_on": [],
                "learning_focus": rule["focus"],
                "practice_task": rule["task"],
                "verification": rule["verification"],
                "estimated_weeks": rule["weeks"],
                "improves_dimension": code,
                "evidence_reference": f"dimension:{code}:score:{score:.1f}",
            }
        )
    return steps
...
def profile_snapshot(
    ...
    *,
    ...
    if next_question is None and version.workflow_status_code == "draft":
    ...
    dimension_coverage = _profile_dimension_coverage(version)
    ...
    summary.update(
        {
            ...
            "dialogue_history": _dialogue_snapshots(db, version.candidate_profile_version_id),
            "profile_dimension_coverage": dimension_coverage,
            "missing_profile_dimensions": [
                {
                    "code": code,
                    "label": PROFILE_DIMENSION_LABELS[code],
                }
                for code, covered in dimension_coverage.items()
                if not covered
            ],
            "can_publish": _profile_can_publish(version),
...
def _requirement_leaf_snapshots(expression: dict | None) -> dict[int, dict]:
    """Flatten the persisted requirement DSL without losing leaf semantics."""
    leaves: dict[int, dict] = {}

    def visit(node: object) -> None:
        if not isinstance(node, dict):
            return
        raw_id = node.get("technology_node_id")
        try:
            technology_id = int(raw_id) if raw_id is not None else None
        except (TypeError, ValueError):
            technology_id = None
        if technology_id is not None:
            current = leaves.setdefault(
                technology_id,
                {
                    "operator": str(node.get("operator") or "SKILL").upper(),
                    "hard": False,
                    "weight": 0.0,
                    "evidence_refs": [],
                },
            ...
            current["hard"] = (
                current["hard"]
                or bool(node.get("hard"))
                or (str(node.get("operator") or "").upper() == "MUST")
            )
            try:
                current["weight"] = max(current["weight"], float(node.get("weight", 1.0)))
            except (TypeError, ValueError):
                current["weight"] = max(current["weight"], 1.0)
...
def _required_capability_graph_snapshot(
    db: Session,
    *,
    profile_version_id: int,
    recommendation: dict,
    gaps: list[CandidateMatchGap],
) -> dict:
    """Project must-cover requirements onto the canonical L1-L4 skill tree."""
    expression = recommendation.get("requirement_expression")
    leaves = _requirement_leaf_snapshots(expression)
    required_ids = set(leaves)
    source = (recommendation.get("acquisition_policy") or {}).get(
        "requirement_source", "compiled_flat_requirements"
    )
    if not required_ids:
        return {
            "requirement_source": source,
            "expression_operator": (expression or {}).get("operator"),
            "total_count": 0,
            "covered_count": 0,
            "unresolved_count": 0,
    ...
    evidence_rows = list(
        db.scalars(
            ...
            .where(
                CandidateSkillEvidence.candidate_profile_version_id == profile_version_id,
                CandidateSkillEvidence.technology_node_id.in_(required_ids),
            )
            .order_by(
                CandidateSkillEvidence.technology_node_id,
                CandidateSkillEvidence.user_confirmed.desc(),
                CandidateSkillEvidence.confidence_score.desc(),
            )
        )
    )
    evidence_by_id: dict[int, CandidateSkillEvidence] = {}
    for evidence in evidence_rows:
        evidence_by_id.setdefault(evidence.technology_node_id, evidence)
    version = _get_version_by_id(db, profile_version_id)
    confirmed_missing_ids = _confirmed_missing_technology_ids(version)
    gap_by_id = {gap.technology_node_id: gap for gap in gaps}

    node_by_id: dict[int, TechnologyNode] = {}
    pending = set(required_ids)
    while pending:
        fetched = list(
            db.scalars(select(TechnologyNode).where(TechnologyNode.technology_node_id.in_(pending)))
        )
        if not fetched:
            break
        pending = set()
        for node in fetched:
            node_by_id[node.technology_node_id] = node
            if (
                node.parent_technology_node_id is not None
                and node.parent_technology_node_id not in node_by_id
            ):
                pending.add(node.parent_technology_node_id)

    primary_domains = {
        relation.technology_node_id: domain
        for relation, domain in db.execute(
            select(TechnologyNodeDomain, TechnologyDomain)
            .join(
                TechnologyDomain,
                TechnologyDomain.technology_domain_id == TechnologyNodeDomain.technology_domain_id,
            )
            .where(
                TechnologyNodeDomain.technology_node_id.in_(required_ids),
                TechnologyNodeDomain.is_primary.is_(True),
            )
        )
    }
    items = []
    for technology_id in sorted(
        required_ids,
        key=lambda item: (
            node_by_id[item].technology_code if item in node_by_id else "",
            item,
        ),
    ):
        node = node_by_id.get(technology_id)
        if node is None:
            continue
        path = []
        current = node
        ...
        while current and current.technology_node_id not in visited:
            ...
            path.append(
                {
                    "technology_node_id": current.technology_node_id,
                    "technology_code": current.technology_code,
                    "technology_name": current.technology_name,
                    "level_code": current.level_code,
                }
            )
            current = node_by_id.get(current.parent_technology_node_id)
        path.reverse()

        evidence = evidence_by_id.get(technology_id)
        gap = gap_by_id.get(technology_id)
        if technology_id in confirmed_missing_ids:
            coverage_status = "confirmed_missing"
        elif evidence is not None and (
            evidence.user_confirmed or evidence.evidence_level_code in {"verified", "contextual"}
        ):
            coverage_status = "covered"
        elif evidence is not None:
            coverage_status = "partial_evidence"
        elif gap is not None and gap.gap_type_code in {
            "depth_insufficient",
            "transferable",
        }:
            coverage_status = gap.gap_type_code
        else:
            coverage_status = "evidence_insufficient"
        candidate_evidence = []
        if evidence is not None:
            candidate_evidence.extend(
                item for item in [evidence.evidence_text, evidence.raw_mention] if item
            )
        if gap is not None:
            candidate_evidence.extend(str(item) for item in gap.candidate_evidence_json or [])
        job_evidence = list(leaves[technology_id]["evidence_refs"])
        if gap is not None:
            job_evidence.extend(str(item) for item in gap.job_evidence_json or [])
        domain = primary_domains.get(technology_id)
        items.append(
            {
                "technology_node_id": technology_id,
                ...
                "operator": leaves[technology_id]["operator"],
                "hard": leaves[technology_id]["hard"],
                "weight": leaves[technology_id]["weight"],
                "coverage_status": coverage_status,
                "candidate_evidence": list(dict.fromkeys(candidate_evidence)),
                "job_evidence": list(dict.fromkeys(job_evidence)),
                "domain": (
                    {
    ...
    return {
        ...
        "covered_count": sum(item["coverage_status"] == "covered" for item in items),
        "unresolved_count": sum(
            item["coverage_status"]
            in {"evidence_insufficient", "partial_evidence", "depth_insufficient", "transferable"}
            for item in items
        ),
        "confirmed_missing_count": sum(
            item["coverage_status"] == "confirmed_missing" for item in items
        ),
        "items": items,
    }
...
def match_run_snapshot(db: Session, run: CandidateMatchRun) -> dict:
        ...
        results.append(
            {
                ...
                "cluster_code": (
                    cluster.stable_cluster_code
                    if cluster
                    else f"unclustered:{posting.job_code if posting else result.result_code}"
                ),
                "job_title": (
                    posting.job_title_normalized or posting.job_title_raw
                    if posting
                ...
                "job_detail": (
                    {
                        ...
                        "title_raw": posting.job_title_raw,
                        "title_normalized": posting.job_title_normalized,
                        "company": posting.company_name_raw,
                        "region": posting.region_text,
                        "employment_type": posting.employment_type_code,
                        "job_level": posting.job_level_code,
                        "salary_text": posting.salary_text,
                        "salary_min_monthly_cny": (
                            float(posting.salary_min_monthly_cny)
                            if posting.salary_min_monthly_cny is not None
                            else None
                        ),
                        "salary_max_monthly_cny": (
                            float(posting.salary_max_monthly_cny)
                            if posting.salary_max_monthly_cny is not None
                            else None
                        ),
                        "salary_months_per_year": (
                            float(posting.salary_months_per_year)
                            if posting.salary_months_per_year is not None
                            else None
                        ),
                        "education_code": posting.education_code,
                        "education_text": posting.education_text,
                        "experience_min_years": (
                            float(posting.experience_min_years)
                            if posting.experience_min_years is not None
                            else None
                        ),
                        "experience_max_years": (
                            float(posting.experience_max_years)
                            if posting.experience_max_years is not None
                            else None
                        ),
                        ...
                        "collected_at": posting.collected_at.isoformat(),
                        "expired_at": (
                            posting.expired_at.isoformat() if posting.expired_at else None
                        ),
                        "posting_status": posting.posting_status_code,
                        "jd_text": posting.jd_clean_text,
                        "parse_confidence_score": (
                            float(posting.parse_confidence_score)
                            if posting.parse_confidence_score is not None
                            else None
                        ),
                        "publish_score": (
                            float(posting.publish_score)
                            if posting.publish_score is not None
                            else None
                        ),
                        "data_origin": posting.data_origin_code,
                        "data_source_id": posting.data_source_id,
                    }
                    if posting
                    else None
                ),
    ...
    return {
        ...
        "scoring_policy": {
            "llm_used": False,
            "dimension_count": len(MATCH_DIMENSIONS),
            "dimensions": [
...
def match_explanation(db: Session, *, result_code: str) -> dict:
    ...
    return {
        ...
        "model_version": (f"llm:{_llm_model_name()}" if llm_text else "rule_explanation_v1"),
    }
...
def _extract_skill_evidence(
    ...
    *,
    ...
    for term, node in sorted(
        ...
        mention_quote = (
            str(mention.get("evidence_quote", "")).strip() if mention is not None else ""
        )
        evidence_terms = [term, node.technology_name]
        if mention is not None:
            evidence_terms.extend(
                str(mention.get(field, "")).strip() for field in ("raw_name", "normalized_keyword")
            )
        evidence = _strongest_resume_evidence(
            text,
            evidence_terms,
            fallback=mention_quote or _evidence_window(text, term),
        )
...
def _strongest_resume_evidence(
    text: str,
    terms: list[str],
    *,
    fallback: str,
    ...
    """Select the strongest source-locked occurrence instead of the first mention.

    Skill lists often repeat a technology already demonstrated in work history.
    Selecting the first or model-returned quote can therefore downgrade real
    project evidence to a bare self-claim.  Candidate windows are ranked by a
    fixed action/context rule and remain exact slices of the resume text.
    """
    candidates = [fallback.strip()] if fallback.strip() else []
    lowered = text.casefold()
    for term in dict.fromkeys(item.strip() for item in terms if item and item.strip()):
        start = 0
        needle = term.casefold()
        while needle and (index := lowered.find(needle, start)) >= 0:
            candidates.append(
                text[max(0, index - radius) : min(len(text), index + len(term) + radius)].strip()
            )
            start = index + max(1, len(term))

    def evidence_rank(value: str) -> tuple[int, int, int]:
        contextual = int(_resume_skill_evidence_level(value) == "contextual")
        action_count = sum(
            term in value.casefold()
            for term in ("负责", "主导", "参与", "完成", "通过", "设计", "验证", "优化")
        )
        # Prefer concise evidence after evidence strength is equal.
        return contextual, action_count, -len(value)

    return max(candidates, key=evidence_rank) if candidates else fallback


def _resume_question_context(version: CandidateProfileVersion) -> dict:
    """Return source-locked resume signals used by the question planner."""
    facts = version.fact_json or {}
    structured = facts.get("structured") or {}
    projects = [item for item in (structured.get("projects") or []) if isinstance(item, dict)]
    experiences = [
        item for item in (structured.get("work_experiences") or []) if isinstance(item, dict)
    ]
    education = [item for item in (structured.get("education") or []) if isinstance(item, dict)]
    dimensions = structured.get("profile_dimensions") or {}
    keywords = []
    for item in facts.get("resume_keywords") or []:
        if isinstance(item, dict):
            value = item.get("normalized_keyword") or item.get("raw_name")
        else:
            value = item
...
def _dimension_has_items(raw: object) -> bool:
...
def _profile_dimension_coverage(version: CandidateProfileVersion) -> dict[str, bool]:
    """Map accepted resume/user evidence to the seven large profile nodes."""
    ...
    responsibility_records = [*experiences, *projects]
    has_responsibility = _dimension_has_items(dimensions.get("job_responsibilities"))
    if not has_responsibility:
        has_responsibility = any(
            bool(item.get("role") or item.get("summary")) for item in responsibility_records
        )

    coverage = {
        "job_responsibilities": has_responsibility,
        "required_skills": _dimension_has_items(dimensions.get("required_skills"))
        or bool(context["skills"]),
        "tools_platforms": _dimension_has_items(dimensions.get("tools_platforms")),
        "education_major": _dimension_has_items(dimensions.get("education_major"))
        or bool(context["education"])
        or bool(version.education_text),
        "work_experience": _dimension_has_items(dimensions.get("work_experience"))
        or bool(experiences),
        "application_scenarios": _dimension_has_items(dimensions.get("application_scenarios")),
        "generic_capabilities": _dimension_has_items(dimensions.get("generic_capabilities")),
    }
...
def _question_known(version: CandidateProfileVersion, question_code: str) -> bool:
    if question_code in (version.preference_json or {}):
        return True
    context = _resume_question_context(version)
    if question_code == "target_role":
        return bool(version.target_role_text)
    return _profile_dimension_coverage(version).get(question_code, False)
...
def _personalized_question_text(
    version: CandidateProfileVersion,
    question_code: str,
    fallback: str,
) -> str:
    """Render a question from accepted resume facts without calling an LLM."""
    context = _resume_question_context(version)
    target = (version.target_role_text or "").strip()
    skills = "、".join(context["skills"])
    if question_code == "target_role" and skills:
        return f"简历中提到了{skills}。你最希望把这些能力用于哪类岗位和工作内容？"
    if question_code == "job_responsibilities" and target:
        return f"简历中还没有清楚说明与“{target}”相关的职责。请选一段经历，说明你负责什么、采取了哪些行动，以及结果。"
    if question_code == "required_skills" and target:
        return f"简历中还没有识别出支撑“{target}”的明确技能。请列出实际使用过的核心技能，并说明各自用于什么任务。"
    if question_code == "tools_platforms" and target:
        return f"简历中还没有识别出与“{target}”相关的工具或平台。请列出实际使用过的软件、框架、设备或平台及其用途。"
    if question_code == "application_scenarios" and (target or skills):
        return f"简历中还没有明确体现应用场景。你的{target or skills}经历主要面向哪些行业、产品或机器人场景？"
    return fallback
...
def _profile_can_publish(version: CandidateProfileVersion) -> bool:
    if version.conversation_round_count >= MIN_DIALOGUE_ROUNDS:
        return True
    coverage = _profile_dimension_coverage(version)
    return bool(version.target_role_text) and all(coverage.values())
...
def _update_completeness(db: Session, version: CandidateProfileVersion) -> None:
    ...
    covered_dimensions = sum(_profile_dimension_coverage(version).values())
    score += min(covered_dimensions * 2, 14)
...
def _cluster_requirement_profile(
    ...
    bonus -= required
    avg_confidence = {tech: sum(values) / len(values) for tech, values in confidence_acc.items()}
...
def _dsl_evidence_value(
    ...
    *,
    ...
    minimum_months, maximum_months, recency_lower, recency_upper = _evidence_timeline_bounds(
        evidence.evidence_text or "", reference_date
    )
...
def _is_strong_evidence(evidence: CandidateSkillEvidence) -> bool:
    return _evidence_state(evidence) in {"verified", "contextual"} and (
        float(evidence.confidence_score) >= 80 or len(evidence.evidence_text or "") >= 80
    )


GAP_EXPLANATIONS = {
    "confirmed_missing": ("候选人在补充问答中明确表示不具备或不考虑该技术，按已确认缺失处理。"),
    ...
    "low_confidence_requirement": ("该技术在岗位 JD 中的要求置信度偏低，建议先核实岗位要求本身。"),
}
...
def _latest_requirement_expression(
    ...
    if job_cluster_version_id is None:
        return None
    return db.scalar(
...
def _score_cluster(
    ...
    version: CandidateProfileVersion,
    cluster: JobClusterVersion | PostingMatchTarget,
    metrics: list[dict],
    member_ids: set[int],
    ...
    *,
    ...
    jd_text = " ".join(
        ...
        for text in db.scalars(
            select(JobPosting.jd_clean_text).where(
                JobPosting.job_posting_id.in_(member_ids or {-1})
            )
        )
        if text
    )
    document_coverage = _jd_evidence_coverage(resume_text, jd_text)
    confirmed_missing_ids = _confirmed_missing_technology_ids(version)
    required_tech, bonus_tech, tech_confidence = _cluster_requirement_profile(db, nodes, member_ids)
    ...
    strict_req_metrics = [item for item in metrics if item["technology_node_id"] in required_tech]
    ...
    if document_coverage is not None:
        document_required_lower = document_coverage * 0.75
        document_required_upper = min(
            0.98,
            document_coverage + 0.20 * (1.0 - document_coverage),
        )
        if stored_expression is not None or strict_req_metrics:
            required_lower = 0.70 * required_lower + 0.30 * document_required_lower
            required_upper = 0.70 * required_upper + 0.30 * document_required_upper
            required_fit = 0.70 * required_fit + 0.30 * document_coverage
        else:
            required_lower = document_required_lower
            required_upper = document_required_upper
            required_fit = document_coverage
    ...
    if matched_evidence:
        ...
        proficiency_lower = sum(item[0] for item in proficiency_bounds) / len(proficiency_bounds)
        proficiency_upper = sum(item[1] for item in proficiency_bounds) / len(proficiency_bounds)
        proficiency_fit = (proficiency_lower + proficiency_upper) / 2
    else:
        demonstrated_depth = _resume_document_proficiency(resume_text)
        if demonstrated_depth is not None and document_coverage is not None:
            proficiency_fit = 0.65 * demonstrated_depth + 0.35 * document_coverage
            proficiency_lower = max(0.0, proficiency_fit - 0.12)
            proficiency_upper = min(0.95, proficiency_fit + 0.08)
        else:
    ...
    if document_coverage is not None:
        # Title/cluster relevance establishes occupation direction; source-text
        # coverage distinguishes a precise JD from a vague same-title posting.
        task_fit = 0.35 * task_fit + 0.65 * document_coverage
    ...
    if document_coverage is not None:
        # Explicit resume/JD concept overlap is contextual source evidence.  It
        # can improve an uncertain taxonomy projection but cannot manufacture a
        # perfect verified score by itself.
        document_project_lower = document_coverage * 0.72
        document_project_upper = min(0.95, document_coverage * 0.90 + 0.05)
        project_lower = max(project_lower, document_project_lower)
        project_upper = max(project_lower, project_upper, document_project_upper)
    ...
    if not known_recency:
        document_recency = _recency_score_bounds(resume_text, reference_date)
        if document_recency is not None:
            known_recency.append(document_recency)
    if known_recency:
    ...
    if scenario_text:
        scenario_fit = _scenario_preference_fit(
            scenario_text,
            jd_text,
    ...
    level_text = " ".join(
        part
        for part in (
            str(preferences.get("target_level", {}).get("value", "")).strip(),
            version.target_role_text or "",
            version.experience_summary or "",
        )
        if part
    )
    level_fit_value = _career_level_fit(level_text, title_texts)
    level_fit = level_fit_value if level_fit_value is not None else 0.5
                ...
                gaps.append(
                    {
                        ...
                        "candidate_evidence": [f"skill:{evidence.candidate_skill_evidence_id}"],
                        "job_evidence": [
    ...
    transfer_base = (
        sum(float(item["importance"]) for item in transferable) / req_total if req_total else 0.0
    )
    ...
    business_transfer = _jd_evidence_coverage(
        resume_text,
        jd_text,
        concept_keys=BUSINESS_TRANSFER_CONCEPT_KEYS,
    )
    if business_transfer is not None:
        business_transfer_score = business_transfer * 0.90
        transfer_score = max(transfer_score, business_transfer_score)
        transfer_lower = max(transfer_lower, business_transfer_score * 0.75)
        transfer_upper = max(
            transfer_lower,
            transfer_upper,
            min(0.95, business_transfer_score + 0.10),
        )
    ...
    values = {
        ...
        "bonus_capability_fit": (
            ...
            bonus_lower,
            bonus_upper,
            "interval_scored" if bonus_metrics else "neutral_unknown",
        ),
        "proficiency_fit": (
            proficiency_fit,
            proficiency_lower,
        ...
        "recency_fit": (
            ...
            recency_lower,
            recency_upper,
            "interval_scored" if known_recency else "neutral_unknown",
        ),
        "scenario_fit": (
            scenario_fit,
            scenario_fit,
            scenario_fit,
            "scored" if scenario_text else "neutral_unknown",
        ),
        "level_fit": (
            level_fit,
            level_fit,
            level_fit,
            "scored" if level_fit_value is not None else "neutral_unknown",
        ),
        "transferable_fit": (
            transfer_score,
            transfer_lower,
            ...
            payload["technologies"] = [
                {
                    "technology_node_id": technology_id,
                    "technology_name": (
                        nodes[technology_id].technology_name if technology_id in nodes else None
                    ),
                }
    ...
    return {
        ...
        "requirement_proof": (requirement_evaluation.proof if requirement_evaluation else None),
        "acquisition_policy": {
            ...
            "requirement_expression_version": (
                stored_requirement.expression_version_no if stored_requirement is not None else None
            ),
        },
            ...
            questions.append(
                {
                    ...
                    "value_components": {
                        "expected_value_of_information": plan_data["expected_value_of_information"],
                        "robust_value_of_information": plan_data["robust_value_of_information"],
                        "expected_interval_shrink": plan_data["expected_interval_shrink"],
...
def _jd_evidence_coverage(
    resume_text: str,
    jd_text: str,
    *,
    concept_keys: set[str] | None = None,
) -> float | None:
    """Return weighted deterministic coverage for concepts explicitly in the JD.

    `None` means that the compact concept dictionary cannot judge this JD, so
    callers preserve the existing neutral/taxonomy behavior instead of treating
    an unsupported domain as a mismatch.
    """
    normalized_resume = _normalized_evidence_text(resume_text)
    normalized_jd = _normalized_evidence_text(jd_text)
    if not normalized_resume or not normalized_jd:
        return None
    total_weight = matched_weight = 0.0
    concepts = (
        JD_EVIDENCE_CONCEPTS.items()
        if concept_keys is None
        else (
            (key, JD_EVIDENCE_CONCEPTS[key]) for key in concept_keys if key in JD_EVIDENCE_CONCEPTS
        )
    )
    for _key, (weight, aliases) in concepts:
        normalized_aliases = tuple(_normalized_evidence_text(alias) for alias in aliases)
        if not any(alias and alias in normalized_jd for alias in normalized_aliases):
            continue
        total_weight += weight
        if any(alias and alias in normalized_resume for alias in normalized_aliases):
...
def _profile_evidence_text(version: CandidateProfileVersion, resume_text: str) -> str:
    """Combine immutable resume text with user-confirmed, source-aware answers."""
    parts = [resume_text, version.target_role_text or "", version.experience_summary or ""]
    facts = version.fact_json or {}
    structured = facts.get("structured") or {}
    for section in ("work_experiences", "projects", "education"):
        for item in structured.get(section) or []:
            if isinstance(item, dict):
                parts.append(str(item.get("evidence_quote") or ""))
    for item in (version.preference_json or {}).values():
        if isinstance(item, dict) and item.get("source") == "user_confirmed":
            parts.append(str(item.get("value") or ""))
    return "\n".join(part.strip() for part in parts if part and part.strip())


def _resume_document_proficiency(text: str) -> float | None:
    """Estimate demonstrated depth from explicit tenure, scope and outcomes."""
    normalized = unicodedata.normalize("NFKC", text or "").casefold()
    if not normalized:
        return None
    years = [int(value) for value in re.findall(r"(\d{1,2})\s*年[^\n]{0,20}经验", normalized)]
    has_scope = bool(re.search(r"(?:管理|下辖|带领)[^\n]{0,16}\d+\s*(?:人|名|个团队)", normalized))
    has_result = bool(re.search(r"\d+(?:\.\d+)?\s*(?:%|亿|万|万元|亿元|家)", normalized))
    action_count = sum(
        term in normalized
        for term in ("负责", "主导", "推动", "完成", "达成", "提升", "增长", "重构")
    )
    if (years and max(years) >= 8) and has_scope and has_result:
        return 0.90
    if (years and max(years) >= 5) and (has_scope or has_result):
        return 0.82
    if action_count >= 3 and has_result:
        return 0.75
    if action_count >= 2:
        return 0.65
    return None
...
def _scenario_preference_fit(scenario_text: str, jd_text: str, label: str) -> float:
    coverage = _jd_evidence_coverage(
        scenario_text,
        jd_text,
        concept_keys=SCENARIO_CONCEPT_KEYS,
    )
    lexical = _text_overlap(scenario_text, f"{label} {jd_text[:1200]}")
    if coverage is None:
        return lexical
    return min(1.0, 0.85 * coverage + 0.15 * lexical)


def _career_level_fit(candidate_text: str, posting_titles: list[str]) -> float | None:
    def level(value: str) -> int | None:
        normalized = value.casefold()
        if any(term in normalized for term in ("副总裁", "vp", "事业部总经理")):
            return 5
        if any(term in normalized for term in ("总监", "director", "head of")):
            return 4
        if any(term in normalized for term in ("经理", "负责人", "manager", "主管")):
            return 3
        if any(term in normalized for term in ("高级", "资深", "senior", "专家")):
            return 2
        if any(term in normalized for term in ("初级", "助理", "junior", "专员")):
            return 1
        if any(term in normalized for term in ("实习", "intern")):
            return 0
        return None

    candidate_level = level(candidate_text)
    posting_levels = [item for title in posting_titles if (item := level(title)) is not None]
    if candidate_level is None or not posting_levels:
        return None
    scores = []
    for posting_level in posting_levels:
        difference = posting_level - candidate_level
        if difference == 0:
            scores.append(1.0)
        elif difference == -1:
            scores.append(0.78)
...
def _normalize_role_title(text: str) -> str:
    ...
    value = re.sub(r"j\d{4,}|mj\d+", "", value)
    for noise in ROLE_TITLE_NOISE:
        value = value.replace(noise.casefold(), "")
    return re.sub(r"[^a-z0-9+#\u4e00-\u9fff]+", "", value)
...
def _role_title_relevance(target_role: str | None, posting_title: str | None) -> float:
    """Deterministic occupation-title compatibility used only for ranking."""
    if not target_role or not posting_title:
        return 0.0
    target = _normalize_role_title(target_role)
    title = _normalize_role_title(posting_title)
    if not target or not title:
        return 0.0
    target_families = _role_families(target_role)
    title_families = _role_families(posting_title)
    missing_specific_families = target_families - title_families - {"product", "project"}
    if target in title or (title in target and len(title) >= max(3, round(len(target) * 0.65))):
        return 0.68 if missing_specific_families else 1.0
    target_parts = {
        _normalize_role_title(part)
        for part in re.split(r"[/|、,，;；()（）]", target_role)
        if _normalize_role_title(part)
    }
    if any(
        len(part) >= 2 and part not in ROLE_GENERIC_PARTS and part in title for part in target_parts
    ):
        return 0.92
    generic_ascii = {"manager", "engineer", "director", "senior", "junior", "head"}
    target_ascii = set(re.findall(r"[a-z][a-z0-9+#]{1,}", target_role.casefold()))
    title_ascii = set(re.findall(r"[a-z][a-z0-9+#]{1,}", posting_title.casefold()))
    if (target_ascii & title_ascii) - generic_ascii:
        return 0.88
    shared_families = target_families & title_families
    specific_shared = shared_families - {"product", "project"}
    family_score = 0.58 if specific_shared else 0.35 if shared_families else 0.0
    if target_families and title_families and not shared_families:
        family_score = 0.0
    lexical_score = _text_overlap(target, title)
    target_specific = target_families - {"product", "project"}
    if target_specific and not (target_specific & title_families):
        lexical_score = min(lexical_score, 0.35)
    if missing_specific_families:
        lexical_score = min(lexical_score, 0.35)
    if shared_families:
        lexical_score = max(lexical_score, 0.35)
    return round(min(1.0, max(family_score, lexical_score)), 6)


def _role_relevance_band(score: float) -> int:
    if score >= 0.72:
        return 2
    if score >= 0.40:
        return 1
...
def _dialogue_snapshots(db: Session, version_id: int) -> list[dict]:
    turns = db.scalars(
        select(CandidateDialogueTurn)
        .where(CandidateDialogueTurn.candidate_profile_version_id == version_id)
        .order_by(CandidateDialogueTurn.turn_no)
    )
    return [
        {
            ...
            "answer_source_code": turn.answer_source_code,
...
def _evidence_acquisition_rounds(version: CandidateProfileVersion, cluster_code: str) -> int:
    history = list(
        ((version.fact_json or {}).get("evidence_acquisition") or {}).get("history") or []
    )
